...
Navigation : v22 roma route (ep 90473746) + weed-repair
Market     : rule-based sell/buy + price-gate + opponent-weighted impact-sort + terminal liquidation
"""
...
_ACTIONS = __import__('json').loads(zlib.decompress(base64.b85decode(
...
def _impact_slots(obs, action, opponent_exposure=None):
    ...
    rows   = [
        (_impact_score(obs, o, opponent_exposure), -i, list(o))
